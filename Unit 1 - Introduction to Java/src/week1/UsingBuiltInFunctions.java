...
public class UsingBuiltInFunctions {
  public static void main(String[] args) {
    ...
    // pass in two integers and find a random number between those two numbers inclusive
  ...
  private static void exampleTwo() {
    ...
    // Want to get a random integer between 1 and 10
    // for(int i = 0; i<100; i++){
    ...
    for(int i = 0; i<100; i++){
      int randomNumber2 = (int)(Math.random() * 10) + 1;      // multiplies every possible number by 10 and casts as an int
